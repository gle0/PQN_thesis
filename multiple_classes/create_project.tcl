...
#
# create_project.tcl: Tcl script for re-creating project 'multi_RS-FS-LTS-IB'
#
# Generated by Vivado on Tue Jul 18 12:50:13 +0900 2023
...
set _xil_proj_name_ "multi_RS-FS-LTS-IB"
...
set files [list \
 [file normalize "${origin_dir}/src/hdl/FS.vhd"]\
 [file normalize "${origin_dir}/src/hdl/IB.vhd"]\
 [file normalize "${origin_dir}/src/hdl/I_receiver.vhd"]\
 [file normalize "${origin_dir}/src/hdl/LTS.vhd"]\
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/src/ip/blk_ram1/blk_ram1.xci"]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "blk_ram1/blk_ram1.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
